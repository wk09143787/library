...
public class Librarytest {
	public static void main(String[] arges) throws InterruptedException{
		Book book1 = new Book("老王", "JAVA", "1562", "spring MVC");
		Book book2 = new Book("老王", "JAVA", "4651", "java核心卷程I");
		Book book3 = new Book("老王", "JAVA", "3652", "java核心卷程II");
		
		Member member = new Member("测试");
		BookShelf shelf = new BookShelf("老王", "JAVA");
		shelf.addBook(book1);
		shelf.addBook(book2);
		shelf.addBook(book3);
